...
mkdir shared
cp ../examples/digest/ta/target/aarch64-unknown-optee-trustzone/debug/*.ta shared
cp ../examples/digest/host/target/aarch64-unknown-linux-gnu/debug/digest shared
