...
cp ../examples/client_pool-rs/ta/target/$TARGET_TA/release/*.ta$QEMU_HOST_SHARE_DIR
cp ../examples/client_pool-rs/host/target/$TARGET_HOST/release/client_pool-rs$QEMU_HOST_SHARE_DIR
