...
cp ../examples/acipher-rs/ta/target/$TARGET_TA/release/*.ta$QEMU_HOST_SHARE_DIR
cp ../examples/acipher-rs/host/target/$TARGET_HOST/release/acipher-rs$QEMU_HOST_SHARE_DIR
