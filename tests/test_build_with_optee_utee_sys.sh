...
cp ../examples/build_with_optee_utee_sys-rs/ta/target/$TARGET_TA/release/*.ta$QEMU_HOST_SHARE_DIR
cp ../examples/build_with_optee_utee_sys-rs/host/target/$TARGET_HOST/release/build_with_optee_utee_sys-rs$QEMU_HOST_SHARE_DIR
